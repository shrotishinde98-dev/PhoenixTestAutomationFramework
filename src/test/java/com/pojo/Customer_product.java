...
public class Customer_product {
	 ...
	 public String toString() {
		return "Customer_product [dop=" + dop + ", serial_number=" + serial_number + ", imei1=" + imei1 + ", imei2="
				...
				+ ", getDop()=" + getDop() + ", getSerial_number()=" + getSerial_number() + ", getImei1()=" + getImei1()
				+ ", getImei2()=" + getImei2() + ", getPopurl()=" + getPopurl() + ", getProduct_id()=" + getProduct_id()
				+ ", getMst_model_id()=" + getMst_model_id() + ", getClass()=" + getClass() + ", hashCode()="
