...
public class Customer {
	   ...
	   private String first_name;
		...
		public String toString() {
			return "Customer [first_name=" + first_name + ", last_name=" + last_name + ", mobile_number="
					+ mobile_number + ", mobile_number_alt=" + mobile_number_alt + ", email_id=" + email_id
					+ ", email_id_alt=" + email_id_alt + ", getFirst_name()=" + getFirst_name() + ", getLast_name()="
					+ getLast_name() + ", getMobile_number()=" + getMobile_number() + ", getMobile_number_alt()="
					+ getMobile_number_alt() + ", getEmail_id()=" + getEmail_id() + ", getEmail_id_alt()="
					+ getEmail_id_alt() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
					+ super.toString() + "]";
		}
